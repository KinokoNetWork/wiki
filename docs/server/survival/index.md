...
処罰に関して気になることは、[よくある質問](../../info/qa.md)または、[処罰ログ](../../news/punish_log.md)をご確認ください。
## 禁止事項
...
2. 困っていたら助けよう。
3. 一般常識を持とう。
4. 自分の建築物・所有物とわかるようにしよう。
5. TTを作成時には、コマンド(`tt`)で、座標と種類を言うようにしよう。
6. ワールド内で長時間放置したり、同種のTTをあまり作成しないようにしよう。
7. エンティティ放置型TTは、1人2個にし、自分が参加している時のみ使用しよう。
