---
title: 運営募集について
description: サーバーを管理者の他に、支持するメンバーを募集しています！！https://mineidea.net/projects/5247340957
sidebar: true
---
# 運営募集について
...
### 応募したいけど、生半可な気持ち...
別に、コミュ力があれば、大体の仕事はできるはずです。極端に、役職の仕事ができないのであれば、話は別ですが...<br>

過去に、「1000人以上のサーバー運営してるんでー」みたいな調子こいた、志望動機を書いてきた人がいましたが、サーバー運営しているのは、鯖主であり、運営ではありませんので、蹴りました。<br>

別に、↑のスキルが悪いというわけではありませんが、志望動機が浅いと、蹴る対象となります。逆に自分の持っているスキルを強調し、志望動機に書く場合は、評価対象とはなると思います。<br>

## 運営募集する際の注意点
MineIdea（外部サービス）に、**運営募集要項**が記載されております。運営になりたいと志願している方は、MineIdea先のGoogleフォームから応募できます。<br>
ですが、鯖主やAdminが、面接形式のメッセージのやり取りをしてから、運営メンバー採用となりますので、生半可（軽い）気持ちで、参加しようとするのならば、その程度で跳ね返します。<br>
...
そこで、鯖主とAdministratorにつくメンバーが、いくつか質問を行い、運営審査を行います。<br>

その持っている技術を生かしたい方や新たな技術を身に着けたい方の募集をお待ちしております。<br>
[きのこサーバー公式Discord](https://discord.com/invite/Rf5xP5JptK)<br>

[応募フォーム https://forms.gle/oDQsD9qEpoZWTLdcA](https://forms.gle/oDQsD9qEpoZWTLdcA)<br>

::: details MineIdeaの紹介文
<code>
<h3><span style="color: rgb(45, 194, 107); background-color: rgb(251, 238, 184);">気軽に、マイクラサーバー<span style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);"><span style="color: rgb(45, 194, 107); background-color: rgb(251, 238, 184);">運営</span>しませんか？</span></span></h3>
<p><span style="font-size: 14pt;">『きのこサーバー２』の運営募集ページです。</span><br><br>サバイバルサーバーでは、<strong><span style="color: rgb(230, 126, 35);">バニラを保ったサーバーを運営</span></strong>したく、どの年の<strong>プレイヤーでも遊べるようなサーバーを作りたい</strong>です。<br>参加人数も、<strong>1日で平均5人以上は、参加している</strong>勢いです。</p>
<p>ただサバイバルでも、やることがなくなった向けで、特別なミッション等を用意して、<strong>サバイバル鯖を盛り上げるような</strong>仕組みを作成しています。</p>
<p dir="auto">そして、本命である、経済鯖を作りたいですが、ほかの鯖とは違う、<span style="background-color: rgb(251, 238, 184); color: rgb(224, 62, 45);"><strong>プレイヤーの一人一人がサーバールール（所謂、法）を変えれるような民主主義サーバー</strong></span>を目指します。</p>
<p dir="auto">大人～子供まで、<span style="color: rgb(224, 62, 45); background-color: rgb(251, 238, 184);"><strong>気軽に参加できるようなサーバーを目指します。</strong></span></p>
<p dir="auto">サーバー内の建築物作成や経済要素の安定をとるための<strong><span style="color: rgb(224, 62, 45); background-color: rgb(251, 238, 184);">企画案の作成</span></strong>など、サーバー運営に必要な人数が一向に揃わない状況です。</p>
<p dir="auto"><strong><span style="background-color: rgb(251, 238, 184); color: rgb(45, 194, 107);">サーバーを見守る人</span></strong>から<strong><span style="color: rgb(224, 62, 45); background-color: rgb(251, 238, 184);">バリバリ開発者</span></strong>の方まで募集中です。<br><br>別に、技術がない方でも、技術を身に着けたいという志（こころざし）さえあれば、マイクラサーバーの運営に向いてます。<br><br>サーバーの構成的には、Lobby鯖、サバイバル鯖、経済鯖（未公開）、ミニゲーム鯖（未公開）があります。</p>
<hr>
<p><strong><span style="font-size: 18pt; background-color: rgb(194, 224, 244);">■募集役職<br></span><span style="font-size: 18pt; background-color: rgb(248, 202, 198);"><span style="font-size: 14pt; background-color: rgb(248, 202, 198);">※現在、経済鯖の建築物をStaffが作成していますが、圧倒的にBuilderの数が少なすぎて嘆いてます。</span></span><span style="font-size: 18pt; background-color: rgb(194, 224, 244);"><br></span></strong></p>
<table class="table table-bordered" style="border-collapse: collapse; width: 100%; height: 471px;" border="0"><colgroup><col style="width: 16.6458%;"><col style="width: 52.5742%;"><col style="width: 30.78%;"></colgroup>
    <tbody>
        <tr style="height: 41px;">
            <td style="height: 41px;">役職名</td>
            <td style="height: 41px;">概要</td>
            <td style="height: 41px;">欲しい技術</td>
        </tr>
        <tr style="height: 89px;">
            <td style="height: 89px;"><span style="background-color: rgb(248, 202, 198);">Administrator<br></span></td>
            <td style="height: 89px;">運営メンバーの総括、サーバー方針への助言などの、鯖主への報告等を仕事とする。</td>
            <td style="height: 89px;">VCができ、<strong>積極的なコミュニケーション</strong>が望まれる。</td>
        </tr>
        <tr style="height: 57px;">
            <td style="height: 57px;">
                <p><span style="background-color: rgb(194, 224, 244);">Developer<br>（募集停止）</span></p>
            </td>
...
<table class="table table-bordered" style="border-collapse: collapse; width: 77.25%; height: 230px;" border="0"><colgroup><col style="width: 41.7323%;"><col style="width: 58.2677%;"></colgroup>
    <tbody>
        <tr style="height: 41px;">
